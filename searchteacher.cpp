...
SearchTeacher::SearchTeacher()
{
    ...
    conditions << "教職員編號" << "姓名" << "所屬系所" << "分機(電話)" << "電子郵件";
    ...
    model->setHeaderData(0, Qt::Horizontal, QObject::tr("教職員編號"));
    model->setHeaderData(1, Qt::Horizontal, QObject::tr("姓名"));
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("所屬系所"));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("電子郵件"));
    model->setHeaderData(4, Qt::Horizontal, QObject::tr("分機(電話)"));
